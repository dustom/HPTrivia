...
struct ContentView: View {
    ...
    @State private var showSetttings = false
    ...
    var body: some View {
        GeometryReader { geo in
            ...
            // this part makes sure, that the ZStack is the same size as the device screen no matter which it is
            .frame(width: geo.size.width, height: geo.size.height)
        }
        .sheet(isPresented: $showInstructions) {
            Instructions()
        }
        .sheet(isPresented: $showSetttings) {
            Settings()
...
//            playAudio()
    ...
    private func playAudio() {
        ...
        // plays over and over to infinity bcs of the -1
